...
public class test_invalid_uname {
    private String userVal = global_variable.invalid_username;
    ...
    public test_invalid_uname(){
        driver = new FirefoxDriver();
        wait = new WebDriverWait(driver, Duration.ofSeconds(3));
    }

    public static void main(String[] args) {
        test_invalid_uname tiu = new test_invalid_uname();
        tiu.invalid_uname();
    }

    public Boolean invalid_uname(){
